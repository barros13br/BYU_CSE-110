#create a story using words that the user entered in input
print("Please enter the following:")
print()

#ask to user put the information
adjective = input("An adjective: ")
animal = input("An animal: ")
verb_1 = input("A verb: ")
exclamation = input("An exclamation: ")
verb_2 = input("Anothoer verb: ")
verb_3 = input("One more verb: ")
adjective_2 = input("Enter other adjective: ")
verb_4 = input("A verb again: ")
adjective_3 = input("One more adjective: ")
verb_5 = input ("Another verb again: ")
verb_6 = input ("And the last one: ")
print()
